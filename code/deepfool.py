...
def deepfool_train(model, inputs, overshoot=0.02, max_iter=50, norm_dist='l_inf', device='cuda', random_start=True, norm_rs='l_inf', epsilon=-1, early_stop=False, model_in_eval=False, df_clamp=True):
    if model_in_eval:
        model.eval()
