...
if [ "$CLUSTERNAME" == "Euler" ]; then
    ...
    PCOMMAND="r/3.5.1 gcc/6.3.0 python_gpu/3.8.5 eth_proxy"
else
...
jupyter notebook --no-browser --ip "\$IP_REMOTE" --notebook-dir /cluster/home/pekang/robustml &> /cluster/home/$USERNAME/jnbinfo 
ENDBSUB
